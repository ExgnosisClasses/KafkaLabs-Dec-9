...
public class StreamingConsumer6_Windowing {
	...
	public static void main(String[] args) {
		...
		config.put("group.id", "kafka-streams-window");
		...
		TimeWindowedKStream<String, Integer> windowedStream = grouped
				.windowedBy(TimeWindows.ofSizeWithNoGrace(Duration.ofSeconds(10)));

		 final KTable<Windowed<String>, Long> actionCount = windowedStream.count();
